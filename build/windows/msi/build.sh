...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Spud - Insiders"
  PRODUCT_CODE="SpudInsiders"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="Spud-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="Spud-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
